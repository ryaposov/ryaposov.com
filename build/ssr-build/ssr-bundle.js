...
module.exports = {"header":"header__3IhT1","header__center":"header__center__kcVzz","header__name":"header__name__3T3SC","header__link":"header__link__17Mk5","header__email":"header__email__3XzO-","header__link_active":"header__link_active__IIUA3"};
...
var realFetch = __webpack_require__("Am05");
...
fetch.fetch = fetch;
fetch.Response = realFetch.Response, fetch.Headers = realFetch.Headers, fetch.Request = realFetch.Request, fetch.polyfill = false;
...
// removed by extract-text-webpack-plugin
module.exports = {"profile":"profile__ilyfo"};
...
var iconvLite = __webpack_require__("rvxu");
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__("oDaZ");
...
var modules = [__webpack_require__("gpsT"), __webpack_require__("/Lr3"), __webpack_require__("I5WA"), __webpack_require__("e0fm"), __webpack_require__("wN2I"), __webpack_require__("PzX9"), __webpack_require__("FbG3"), __webpack_require__("OU4U")];
...
var _require = __webpack_require__("97RM");

var PassThrough = _require.PassThrough;

var convert = void 0;
try {
	convert = __webpack_require__("86Pa").convert;
} catch (e) {}
  ...
  */
	blob: function blob() {
		...
		return consumeBody.call(this).then(function (buf) {
			...
			new Blob([], {
				type: ct.toLowerCase()
			}), (_extends2 = {}, _extends2[BUFFER] = buf, _extends2));
		});
	},
  ...
  */
	function Headers() {
		...
		if (init instanceof Headers) {
			...
			for (var _iterator2 = headerNames, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
				var _ref3;
				...
				var headerName = _ref3;

				for (var _iterator3 = rawHeaders[headerName], _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
					var _ref4;
		...
		if (init == null) {
			...
			if (method != null) {
				...
				var pairs = [];
				for (var _iterator4 = init, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
					var _ref5;
				...
				for (var _iterator5 = pairs, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
					var _ref6;
				...
				for (var _iterator6 = Object.keys(init), _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
					var _ref7;
...
var _require$1 = __webpack_require__("gHkb");
...
var _require$2 = __webpack_require__("Vy1O");
...
var _require$3 = __webpack_require__("97RM");

var PassThrough$1 = _require$3.PassThrough;

var _require2 = __webpack_require__("Vy1O");
...
function fetch(url, opts) {
	...
	return new fetch.Promise(function (resolve, reject) {
		...
		req.on('response', function (res) {
			...
			for (var _iterator7 = Object.keys(res.headers), _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
				var _ref8;
				...
				if (Array.isArray(res.headers[name])) {
					for (var _iterator8 = res.headers[name], _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator]();;) {
						var _ref9;
...
// removed by extract-text-webpack-plugin
module.exports = {"development":"development__3-LsG"};
...
// EXTERNAL MODULE: ./style/main.scss
var main = __webpack_require__("TJ31");
...
var regenerator = __webpack_require__("aIIw");
var regenerator_default = /*#__PURE__*/__webpack_require__.n(regenerator);

// EXTERNAL MODULE: ../node_modules/cross-fetch/dist/node-ponyfill.js
var node_ponyfill = __webpack_require__("3Bfr");
...
var api_config = {
	options: { mode: 'cors' },
	base:  true ? '//api.ryaposov.com/crud' : '//localhost:8082/crud'
};

// Basic wrapper around fetch()
/* harmony default export */ var api = (function (url) {
	var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	return (
		// Default options are marked with *
		node_ponyfill_default()(api_config.base + url, api__extends(api_config.options, options)).then(function (response) {
			return response.json();
		})
	);
});
// CONCATENATED MODULE: ./api/projects.js


var projects__this = this;
			...
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 7:
						...
						return _context.abrupt('return', Promise.resolve(_context.t0));
...
var getOne = function () {
	var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2(id) {
		var data;
			...
			while (1) {
				switch (_context2.prev = _context2.next) {
					...
					case 7:
						...
						return _context2.abrupt('return', Promise.resolve(_context2.t0));
...
// CONCATENATED MODULE: ./store/actions/projects.js


var REQUEST_PROJECTS = 'REQUEST_PROJECTS';
...
function fetchProjectsIfNeeded() {
	...
	return function (dispatch, getState) {
		var should = shouldFetchProjects(getState(), category);
		if (should) {
			return dispatch(fetchProjects(category));
		}
	};
}
// CONCATENATED MODULE: ./store/reducers/projects.js
var projects__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function projects_projects() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultState;
	var action = arguments[1];

	switch (action.type) {
		case RECEIVE_PROJECTS:
			return projects__extends({}, state, {
				isFetching: false,
				didInvalidate: false,
...
/* harmony default export */ var reducers_projects = (projects_projects);
// CONCATENATED MODULE: ./store/actions/project.js
...
function fetchProject(id) {
	return function (dispatch) {
		...
		return getOne(id).then(function (response) {
...
function fetchProjectIfNeeded() {
	var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

	return function (dispatch, getState) {
		var should = shouldFetchProject(getState(), id);
		if (should) {
			return dispatch(fetchProject(id));
		}
	};
}
// CONCATENATED MODULE: ./store/reducers/project.js
var project__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };



var project_defaultState = {
	isFetching: false,
	didInvalidate: false,
	project: {}
};
...
function project_project() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : project_defaultState;
	var action = arguments[1];

	switch (action.type) {
		case RECEIVE_PROJECT:
			return project__extends({}, state, {
				isFetching: false,
				didInvalidate: false,
...
/* harmony default export */ var reducers_project = (project_project);
// CONCATENATED MODULE: ./store/reducer.js




/* harmony default export */ var store_reducer = (combineReducers({
	projects: reducers_projects,
	project: reducers_project
}));
  ...
  return function (state, action) {
    ...
    if (action.type === PERSIST) {
      ...
      if (_purge) return persistReducer__extends({}, restState, {
        ...
        var _newState = persistReducer__extends({}, reconciledRest, {
          _persist: persistReducer__extends({}, _persist, { rehydrated: true })
        });
...
function isPlainEnoughObject(o) {
  return o !== null && !Array.isArray(o) && (typeof o === 'undefined' ? 'undefined' : autoMergeLevel2__typeof(o)) === 'object';
}
...
function persistStore(store, options, cb) {
  ...
  var _pStore = createStore_createStore(persistStore_persistorReducer, persistStore_initialState, options ? options.enhancer : undefined);
  ...
  var persistor = persistStore__extends({}, _pStore, {
...
var lib_storage = __webpack_require__("PJei");
...
var persistedReducer = persistReducer(persistConfig, store_reducer);

/* harmony default export */ var store_0 = (function () {
	var store = createStore_createStore(persistedReducer, applyMiddleware(lib_default.a, loggerMiddleware));
	var persistor = persistStore(store);
	return { store: store, persistor: persistor };
});
// EXTERNAL MODULE: ../node_modules/warning/warning.js
var node_modules_warning_warning = __webpack_require__("XOCG");
...
var style_default = /*#__PURE__*/__webpack_require__.n(header_style);

// CONCATENATED MODULE: ./components/header/menuLinks.js
/* harmony default export */ var menuLinks = ({
	name: 'Pavel Ryaposov',
...
var header = menuLinks;

var header_Header = function Header() {
	return Object(preact_min["h"])(
		'header',
		{ 'class': style_default.a.header },
		Object(preact_min["h"])(
			'div',
			{ 'class': style_default.a.header__center + ' center' },
			Object(preact_min["h"])(
				es_Link,
				{ 'class': style_default.a.header__name, to: '/' },
				header.name
			),
			Object(preact_min["h"])(
				'nav',
				{ 'class': style_default.a.header__nav },
				header.nav.map(function (link) {
					return Object(preact_min["h"])(
						es_Link,
						{ 'class': style_default.a.header__link, activeClassName: style_default.a.header__link_active, to: link.link },
						link.name
					);
				})
			),
			Object(preact_min["h"])(
				'span',
				{ 'class': style_default.a.header__email },
				header.email
			)
		)
	);
...
var footer = menuLinks;

var footer__ref = Object(preact_min["h"])('img', { src: '/assets/img/logo-black.svg' });
...
var footer_Footer = function Footer() {
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			'div',
			{ 'class': footer_style_default.a.footer__center + ' center' },
			Object(preact_min["h"])(
				es_Link,
				{ 'class': footer_style_default.a.footer__logo, to: '/' },
				footer__ref
			),
			Object(preact_min["h"])(
				'nav',
				{ 'class': footer_style_default.a.footer__nav },
				footer.nav.map(function (link) {
					return Object(preact_min["h"])(
						es_Link,
						{ 'class': footer_style_default.a.footer__link, activeClassName: footer_style_default.a.footer__link_active, to: link.link },
						link.name
					);
				})
			),
			Object(preact_min["h"])(
				'span',
				{ 'class': footer_style_default.a.footer__email },
				footer.email
			)
		)
	);
...
// EXTERNAL MODULE: ./components/project/style.scss
var project_style = __webpack_require__("OxL1");
...
var project_Project = function (_Component) {
	...
	function Project() {
		...
		return _ret = (_temp = (_this = project__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.styles = function () {
			return {
				background: _this.props.project.color
			};
		}, _temp), project__possibleConstructorReturn(_this, _ret);
	}

	Project.prototype.render = function render(_ref) {
		var project = _ref.project,
		    className = _ref.className;

		return Object(preact_min["h"])(
			es_Link,
			{ 'class': classnames_default.a.apply(undefined, [project_style_default.a[project_block], project_style_default.a[project_block + '_' + project.size]].concat(className)), style: this.styles(), to: '/project/' + project._id + '/' },
			Object(preact_min["h"])(
				'span',
				{ 'class': project_style_default.a.project__category },
				project.category.reduce(function (a, b) {
					return a + ', ' + b;
				})
			),
			Object(preact_min["h"])(
				'span',
				{ 'class': project_style_default.a.project__title },
				project.title
			)
		);
	};
...
// EXTERNAL MODULE: ./components/projects/style.scss
var projects_style = __webpack_require__("M6rY");
...
var projects_Projects = function (_Component) {
	...
	Projects.prototype.render = function render(_ref) {
		var projects = _ref.projects;

		return Object(preact_min["h"])(
			'div',
			{ 'class': classnames_default()(projects_style_default.a.projects, 'center') },
			projects.map(function (project) {
				return Object(preact_min["h"])(project_Project, { className: classnames_default()(projects_style_default.a.projects__item), project: project });
			})
		);
	};
...
function home__asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
var home_Home = function (_Component) {
	...
	Home.prototype.componentDidMount = function () {
		var _ref = home__asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
			var dispatch;
			return regenerator_default.a.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							_context.next = 3;
							return dispatch(fetchProjectsIfNeeded());
	...
	Home.prototype.render = function render(_ref2) {
		...
		var projectsFiltered = [].concat(projects.items);
		return Object(preact_min["h"])(
			'div',
			{ 'class': home_style_default.a.home },
			Object(preact_min["h"])(components_projects, { projects: projectsFiltered })
		);
	};
...
/* harmony default export */ var home = (connect(mapStateToProps)(home_Home));
// EXTERNAL MODULE: ./routes/development/style.scss
var development_style = __webpack_require__("JOIH");
var development_style_default = /*#__PURE__*/__webpack_require__.n(development_style);

// CONCATENATED MODULE: ./routes/development/index.js



function development__asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

function development__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function development__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function development__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var development_Development = function (_Component) {
	development__inherits(Development, _Component);

	function Development() {
		development__classCallCheck(this, Development);

		return development__possibleConstructorReturn(this, _Component.apply(this, arguments));
	}

	// eslint-disable-line react-prefer-stateless-function
	Development.prototype.componentDidMount = function () {
		var _ref = development__asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
			var dispatch;
			return regenerator_default.a.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
	...
	Development.prototype.render = function render(_ref2) {
		var projects = _ref2.projects;

		var projectsFiltered = [].concat(projects.items.filter(function (project) {
			return project.category.indexOf('Development') > -1;
		}));
		return Object(preact_min["h"])(
			'div',
			{ 'class': development_style_default.a.home },
			Object(preact_min["h"])(components_projects, { projects: projectsFiltered })
		);
	};
...
var development_mapStateToProps = function mapStateToProps(state) {
	return { projects: state.projects };
};

/* harmony default export */ var development = (connect(development_mapStateToProps)(development_Development));
// EXTERNAL MODULE: ./routes/project/style.scss
var routes_project_style = __webpack_require__("UAxM");
var routes_project_style_default = /*#__PURE__*/__webpack_require__.n(routes_project_style);

// CONCATENATED MODULE: ./routes/project/index.js



function project__asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

function routes_project__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function routes_project__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function routes_project__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var _ref3 = Object(preact_min["h"])('img', { src: 'https://images.unsplash.com/photo-1465588042420-47a53c2d0320?ixlib=rb-0.3.5&s=4f37726abb95672b44fde576c79aed26&auto=format&fit=crop&w=1395&q=80' });

var _ref4 = Object(preact_min["h"])('i', { 'class': 'arrow arrow_left' });

var _ref5 = Object(preact_min["h"])(
	'p',
	null,
	'Now equipped with seventh-generation Intel Core processors, MacBook is snappier than ever. From daily tasks like launching apps and opening files to more advanced computing, you can power through your day thanks to faster SSDs and Turbo Boost processing up to.'
);
...
var _ref7 = Object(preact_min["h"])(
	'p',
	null,
	'Create modern ecommerce web-site for UGG Australia official retailer.'
);

var routes_project_Project = function (_Component) {
	routes_project__inherits(Project, _Component);

	function Project() {
		var _temp, _this, _ret;

		routes_project__classCallCheck(this, Project);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = routes_project__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.goBack = function () {
			return _this.props.history.goBack();
		}, _temp), routes_project__possibleConstructorReturn(_this, _ret);
	} // eslint-disable-line react-prefer-stateless-function


	Project.prototype.componentDidMount = function () {
		var _ref = project__asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
			var dispatch;
			return regenerator_default.a.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							dispatch = this.props.dispatch;
							_context.next = 3;
							return dispatch(fetchProjectIfNeeded(this.props.match.params.id));
	...
	Project.prototype.render = function render(_ref2) {
		var project = _ref2.project,
		    match = _ref2.match;

		return Object(preact_min["h"])(
			'div',
			{ 'class': routes_project_style_default.a.project + ' center' },
			project.hasOwnProperty('_id') && Object(preact_min["h"])(
				'div',
				{ 'class': routes_project_style_default.a.project + ' center' },
				Object(preact_min["h"])(
					'div',
					{ 'class': routes_project_style_default.a.project__banner },
					_ref3
				),
				Object(preact_min["h"])(
					'div',
					{ 'class': routes_project_style_default.a.project__content },
					Object(preact_min["h"])(
						'div',
						{ 'class': routes_project_style_default.a.project__intro },
						Object(preact_min["h"])(
							'a',
							{ onClick: this.goBack, 'class': routes_project_style_default.a.project__back },
							_ref4,
							' Go Back'
						),
						Object(preact_min["h"])(
							'h1',
							{ 'class': routes_project_style_default.a.project__title },
							'Website for UGG Australia official retailer'
						),
						Object(preact_min["h"])(
							'div',
							{ 'class': routes_project_style_default.a.project__introtext },
							_ref5,
							_ref6
						)
					),
					Object(preact_min["h"])(
						'div',
						{ 'class': routes_project_style_default.a.project__info },
						Object(preact_min["h"])(
							'div',
							{ 'class': routes_project_style_default.a.project__goal },
							Object(preact_min["h"])(
								'span',
								{ 'class': routes_project_style_default.a.project__label },
								'Project goal'
							),
							_ref7
						),
						Object(preact_min["h"])(
							'div',
							{ 'class': routes_project_style_default.a.project__param },
							Object(preact_min["h"])(
								'span',
								{ 'class': routes_project_style_default.a.project__label },
								'Links'
							...
							Object(preact_min["h"])(
								'a',
								{ target: '_blank', 'class': routes_project_style_default.a.project__value + ' link' },
								'ulime.ryaposov.com'
							)
						),
						Object(preact_min["h"])(
							...
							Object(preact_min["h"])(
								'span',
								{ 'class': routes_project_style_default.a.project__value },
								Object(preact_min["h"])(
									'strong',
									null,
									project.category.reduce(function (a, b) {
...
var project_mapStateToProps = function mapStateToProps(state) {
	return { project: state.project.project };
};

/* harmony default export */ var routes_project = (connect(project_mapStateToProps)(routes_project_Project));
// EXTERNAL MODULE: ./routes/design/style.scss
var design_style = __webpack_require__("3WpW");
var design_style_default = /*#__PURE__*/__webpack_require__.n(design_style);

// CONCATENATED MODULE: ./routes/design/index.js



function design__asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
var design_Design = function (_Component) {
	...
	// eslint-disable-line react-prefer-stateless-function
	Design.prototype.componentDidMount = function () {
		var _ref = design__asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
			var dispatch;
			return regenerator_default.a.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
	...
	Design.prototype.render = function render(_ref2) {
		var projects = _ref2.projects;
		...
		return Object(preact_min["h"])(
			'div',
			{ 'class': design_style_default.a.home },
			Object(preact_min["h"])(components_projects, { projects: projectsFiltered })
		);
	};
...
var design_mapStateToProps = function mapStateToProps(state) {
	return { projects: state.projects };
};

/* harmony default export */ var design = (connect(design_mapStateToProps)(design_Design));
// EXTERNAL MODULE: ./routes/blog/style.scss
var blog_style = __webpack_require__("Ss37");
var blog_style_default = /*#__PURE__*/__webpack_require__.n(blog_style);

// CONCATENATED MODULE: ./routes/blog/index.js


function blog__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function blog__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function blog__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }





var blog_Blog = function (_Component) {
	blog__inherits(Blog, _Component);

	function Blog() {
		blog__classCallCheck(this, Blog);

		return blog__possibleConstructorReturn(this, _Component.apply(this, arguments));
	}
	...
	Blog.prototype.render = function render() {
		return Object(preact_min["h"])(
			'div',
			{ 'class': blog_style_default.a.blog + ' center' },
			Object(preact_min["h"])(
				'div',
				{ 'class': blog_style_default.a.blog__posts },
				[0, 1, 2, 3, 4, 5].map(function (post) {
					return Object(preact_min["h"])(
						'div',
						{ 'class': blog_style_default.a.blog__post },
						Object(preact_min["h"])(
							'h3',
							{ 'class': blog_style_default.a.blog__title },
							Object(preact_min["h"])(
								es_Link,
								{ to: '/blog/' + post + '/' },
								'CSS in a nutshell'
							...
							Object(preact_min["h"])(
								'span',
								{ 'class': blog_style_default.a.blog__time },
								'Wednesday, 23:50'
							)
						),
						Object(preact_min["h"])(
							'div',
							{ 'class': blog_style_default.a.blog__introtext },
						...
						Object(preact_min["h"])(
							es_Link,
							{ to: '/blog/' + post + '/', 'class': blog_style_default.a.blog__further + ' link' },
							'Read more'
						)
					);
				})
...
/* harmony default export */ var blog = (blog_Blog);
// EXTERNAL MODULE: ./routes/post/style.scss
var post_style = __webpack_require__("QMSY");
var post_style_default = /*#__PURE__*/__webpack_require__.n(post_style);

// CONCATENATED MODULE: ./routes/post/index.js
...
function post__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function post__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }




var post__ref = Object(preact_min["h"])('i', { 'class': 'arrow arrow_left' });

var post__ref2 = Object(preact_min["h"])(
	'h3',
	null,
	'CSS in a nutshell'
);

var post__ref3 = Object(preact_min["h"])(
	'p',
	null,
...
var post__ref4 = Object(preact_min["h"])(
	'p',
	null,
	'Each component inside MacBook has been meticulously designed to get the most out of an incredibly thin and light enclosure.'
);

var post__ref5 = Object(preact_min["h"])(
	'p',
	null,
	'Now equipped with seventh-generation Intel Core processors, MacBook is snappier than ever. From daily tasks like launching apps and opening files to more advanced computing, you can power through your day thanks to faster SSDs and Turbo Boost processing up to 3.6GHz.'
);

var post__ref6 = Object(preact_min["h"])(
	'p',
	null,
	'Each component inside MacBook has been meticulously designed to get the most out of an incredibly thin and light enclosure.'
);
...
var post_Post = function (_Component) {
	post__inherits(Post, _Component);
	...
	function Post() {
		...
		return _ret = (_temp = (_this = post__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.goBack = function () {
			return _this.props.history.goBack();
		}, _temp), post__possibleConstructorReturn(_this, _ret);
	} // eslint-disable-line react-prefer-stateless-function
	...
	Post.prototype.render = function render() {
		return Object(preact_min["h"])(
			'div',
			{ 'class': post_style_default.a.post },
			Object(preact_min["h"])(
				'div',
				{ 'class': post_style_default.a.post__banner },
				Object(preact_min["h"])(
					'div',
					{ 'class': 'center' },
					Object(preact_min["h"])(
						'a',
						{ onClick: this.goBack, 'class': post_style_default.a.post__back },
						post__ref,
						' Go Back'
					),
					Object(preact_min["h"])(
						'h1',
						{ 'class': post_style_default.a.post__title },
						'Design, Development'
					),
					Object(preact_min["h"])(
						'p',
						{ 'class': post_style_default.a.post__intro },
						'Create modern ecommerce web-site for UGG Australia official retailer.'
					),
					Object(preact_min["h"])(
						'div',
						{ 'class': post_style_default.a.post__tags },
						Object(preact_min["h"])(
							'span',
							{ 'class': post_style_default.a.post__tag },
							'CSS'
						),
						Object(preact_min["h"])(
							'span',
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					'div',
					{ 'class': post_style_default.a.post__content },
					post__ref2,
					post__ref3,
					post__ref4,
					post__ref5,
...
/* harmony default export */ var routes_post = (post_Post);
...
var router__ref = Object(preact_min["h"])(
	es_BrowserRouter,
	null,
	Object(preact_min["h"])(
		'div',
		{ 'class': 'wrapper' },
		Object(preact_min["h"])(components_header, null),
		Object(preact_min["h"])(
			'div',
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(react_router_dom_es_Route, { path: '/development/', component: development }),
				Object(preact_min["h"])(react_router_dom_es_Route, { path: '/design/', component: design }),
				Object(preact_min["h"])(react_router_dom_es_Route, { path: '/project/:id/', component: routes_project }),
				Object(preact_min["h"])(react_router_dom_es_Route, { path: '/blog/:id/', component: routes_post }),
				Object(preact_min["h"])(react_router_dom_es_Route, { path: '/blog/', component: blog })
			)
		),
		Object(preact_min["h"])(components_footer, null)
	)
);
...
/* harmony default export */ var router_0 = (Routes);
...
if (false) require('preact/debug');

var _configureStore = store_0(),
...
var app__ref = Object(preact_min["h"])(
	...
	Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(router_0, null)
		)
	)
);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__("m/SU")(module)))
...
// removed by extract-text-webpack-plugin
module.exports = {"projects":"projects__i5U-7","projects__item":"projects__item__2p2XB"};
...
var _getStorage = __webpack_require__("d+fn");
...
module.exports = {
    ...
    'shiftjis': {
        ...
        table: function table() {
            return __webpack_require__("RfwA");
        },
    ...
    'eucjp': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__("rQ3g");
        },
        encodeAdd: { '\xA5': 0x5C, '\u203E': 0x7E }
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__("DlSd");
        }
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__("DlSd").concat(__webpack_require__("DLpe"));
        }
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        ...
        gb18030: function gb18030() {
            return __webpack_require__("nBoc");
        },
        encodeSkipVals: [0x80],
        encodeAdd: { '€': 0xA2E3 }
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__("YVyz");
        }
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__("FO1L");
        }
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__("FO1L").concat(__webpack_require__("ezsz"));
        },
...
// removed by extract-text-webpack-plugin
module.exports = {"project":"project__2yX71","project__category":"project__category__f611b","project__title":"project__title__30hFK","project_2-5":"project_2-5__38A5X","project_1-5":"project_1-5__w0iTR"};
...
var _createWebStorage = __webpack_require__("NfND");
...
// removed by extract-text-webpack-plugin
module.exports = {"post":"post__18X5T","post__banner":"post__banner__VLEJm","post__title":"post__title__ilCWf","post__intro":"post__intro__28iPm","post__tags":"post__tags__3oaGi","post__back":"post__back__3W4-A","post__tag":"post__tag__3w9DN","post__content":"post__content__2JVhO"};
...
// removed by extract-text-webpack-plugin
module.exports = {"footer":"footer__3_VRr","footer__center":"footer__center__3j0sU","footer__logo":"footer__logo__26A9j","footer__link":"footer__link__1M9HH","footer__email":"footer__email__1QAMn","footer__link_active":"footer__link_active__1xHVr"};
...
// removed by extract-text-webpack-plugin
module.exports = {"blog":"blog__o4ObN","blog__posts":"blog__posts__eOvsH","blog__title":"blog__title__34jio","blog__post":"blog__post__2DcNB","blog__time":"blog__time__22-D3","blog__further":"blog__further__3QvBW"};
...
// removed by extract-text-webpack-plugin
module.exports = {"project__banner":"project__banner__13CKV","project__back":"project__back__2yveB","project__content":"project__content__21vej","project__title":"project__title__3RYMf","project__intro":"project__intro__2E_8x","project__introtext":"project__introtext__16JLC","project__info":"project__info__1fDWK","project__goal":"project__goal__2PP2N","project__label":"project__label__1Y4v5","project__param":"project__param__1-6kN","project__value":"project__value__3pV71"};
...
var StringDecoder = __webpack_require__("p1Q/").StringDecoder;
...
module.exports = function (iconv) {
    ...
    iconv.extendNodeEncodings = function extendNodeEncodings() {
        ...
        // -- SlowBuffer -----------------------------------------------------------
        var SlowBuffer = __webpack_require__("fy20").SlowBuffer;
        ...
        if (iconv.supportsStreams) {
            var Readable = __webpack_require__("97RM").Readable;
...
var bomHandling = __webpack_require__("Xv17"),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings) iconv.encodings = __webpack_require__("9y+h"); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__("upRl")(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__("ociv")(iconv);
}
...
var Buffer = __webpack_require__("fy20").Buffer,
    Transform = __webpack_require__("97RM").Transform;
